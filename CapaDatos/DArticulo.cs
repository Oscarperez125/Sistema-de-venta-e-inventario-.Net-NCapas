...
namespace CapaDatos
{
    public class DArticulo
    {
        ...
        public DArticulo(int idarticulo, string codigo, string nombre, string descripcion, byte[] image, int idcategoria, int idpresentacion, string textobuscar)
        {
